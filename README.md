...
**Put your HubSpot developer test account custom objects URL link here:** https://app-na2.hubspot.com/contacts/247494491/objects/2-268888408/views/all/list

___
## Tips:
- Commit to your repository often. Even if you make small tweaks to your code, it’s best to be committing to your repository frequently.
- The subject of the custom object is up to you. Feel free to get creative!
- Create a developer test account and keep the private app access token only in a local `.env` file.
...
1. Run `npm install`.
2. Create a local `.env` file containing `PRIVATE_APP_ACCESS=your-token-here`.
3. Run `npm start`.
